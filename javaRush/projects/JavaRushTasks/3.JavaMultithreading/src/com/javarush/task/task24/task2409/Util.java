    ...
    public static List<Jeans> getAllJeans() {
        ...
        abstract class AbstractJeans implements Jeans{
            ...
            public String toString() {
                String output = "%s{id=%d, length=%d, size=%d, price=%.1f}";
                return String.format(output, getTM(), id, length, size, price);
//                // validator accepted this line without 2 getTM methods in next 2 classes
//                return String.format(output, this.getClass().getSimpleName().toString(), id, length, size, price);
            }
        }
