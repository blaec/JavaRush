...
public class Game {
    ...
    private void initializeControlSportsman() {
        ...
        // Validator does not accepts this working solution
//        controlSportsman.setResultTime(new BigDecimal("3640.0").setScale(2, BigDecimal.ROUND_HALF_UP));
    ...
    private List<Sportsman> getSportsmanWithEqualTime() {
        ...
        for (int i = 0; i < members.size(); i++) {
            // As well as this working solution not accepted
