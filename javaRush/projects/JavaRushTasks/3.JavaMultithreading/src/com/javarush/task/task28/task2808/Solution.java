    ...
    public static Callable<String> getTask(final int i) {
        return new Callable<String>() {
            ...
            public String call() throws Exception {
                BigInteger i1 = new BigInteger(String.valueOf(i));
                BigInteger i2 = new BigInteger(String.valueOf(i + 1));
                BigInteger sumOutput = i1.multiply(i2).divide(new BigInteger("2"));
